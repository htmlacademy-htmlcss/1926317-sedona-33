...
* Студент: [Andrey Yolyshev](https://up.htmlacademy.ru/htmlcss/33/user/1926317).
* Наставник: `Роман Марченко` типо добавил vk наставника.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1926317-sedona-33) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
